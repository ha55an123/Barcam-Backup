...
class BarcodeApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.qr_filter_checkbox = QCheckBox("Only Detect QR Codes")

        self.preview_label = QLabel("Snapshot Preview")
        ...
        layout.addWidget(self.qr_filter_checkbox)
        ...
        self.beep_checkbox.stateChanged.connect(self.save_settings)
    ...
    def populate_camera_indices(self, max_test=3):
    ...
    def stop_camera(self):
        ...
        self.weight_label.setText("Weight: N/A")
    ...
    def update_frame(self):
        ...
        for barcode in barcodes:
            ...
            if self.qr_filter_checkbox.isChecked() and barcode_type != "QRCODE":
                continue
        ...
        if self.serial_port and self.serial_port.is_open:
            try:
                ...
                if line:
                    self.weight_label.setText(f"Weight: {line}")
            except:
    ...
    def capture_image(self, frame, barcode_value):
        ...
        rgb_image = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
        h, w, ch = rgb_image.shape
        preview_qimage = QImage(rgb_image.data, w, h, ch * w, QImage.Format_RGB888)
        preview_pixmap = QPixmap.fromImage(preview_qimage).scaled(
